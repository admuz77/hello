...
public class AuctionSys {
    public static void main(String[] args) {
        ...
        auction1.seller.adres = new Adres();
        auction1.seller.adres.city = "Wrocław";
        auction1.seller.adres.postalCode = "50-500";
        auction1.seller.adres.street = "Kościuszki";
        auction1.seller.adres.homeNo = "24A";
        auction1.seller.adres.flatNo = "21";
